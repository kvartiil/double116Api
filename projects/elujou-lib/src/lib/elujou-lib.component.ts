...
import { ApiComponent } from '../lib/api/api.component';
...
@Component({
  ...
  imports: [CommonModule, ElujouLib2Component, UustestComponent, TabComponent, TabzComponent, XteechangeComponent, ApiComponent]
